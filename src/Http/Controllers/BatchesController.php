...
class BatchesController extends Controller
{
    ...
    /**
     * Get the dashboard-only batch overview (latest active previews).
     *
     * Active-batch counts for navigation live on /api/stats. This endpoint only
     * returns the latest three active batch previews when database batching is
     * available.
     *
     * @return array
     */
    ...
    /**
     * Build a query of active/in-progress batches.
     *
