...
class WorkloadController extends Controller
{
     ...
     *
     * Uses Laravel's isPaused() semantics so reporting stays aligned with the
     * indefinite pause/resume APIs without Horizon-owned pause storage. Entries
     * without a usable connection are skipped so third-party repositories that
     * omit connection remain compatible.
     *
     * @param  \Illuminate\Queue\QueueManager  $queues
