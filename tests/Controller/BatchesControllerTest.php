...
class BatchesControllerTest extends ControllerTest
{
    ...
    public function test_batch_overview_limits_to_the_latest_three_of_four_active_batches()
    {
        ...
        // Four batches all match the active predicate (not cancelled, pending > failed).
    ...
    public function test_dynamodb_batching_returns_unavailable_overview_shape()
    {
        ...
        // Bind a stub repository so construction does not require DynamoDB credentials;
        // the overview guard must still short-circuit without database storage access.
        $this->app->instance(
