...
class QueuePauseControllerTest extends ControllerTest
{
    ...
    public function test_timed_queue_pausing_accepts_a_duration_in_minutes()
    {
        ...
        try {
            ...
            // pauseFor must expire; indefinite pause() would still be paused after this.
    ...
    public function test_pause_and_resume_endpoints_are_unavailable_when_worker_pause_polling_is_disabled()
    {
        ...
        // Routes are always registered; runtime capability must still refuse mutation.
    ...
    /**
     * Determine whether basic pause APIs exist and are currently usable.
     *
     * @return bool
     */
    ...
    /**
     * Determine whether the installed framework defines basic pause APIs.
     *
     * @return bool
     */
