<script type="text/ecmascript-6">
    ...
    export default {
        ...
        computed: {
            ...
            /**
             * Label for the dispatched-jobs window on the workload card.
             */
            dispatchedJobsPeriod() {
                return !this.$root.statsReady || !this.stats.periods?.recentJobs
                    ? 'Hour'
                    : this.determinePeriod(this.stats.periods.recentJobs);
            },
    ...
    <div class="dashboard">
        ...
        <section class="card dashboard-section dashboard-workload" v-if="workloadReady">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                ...
                <div class="dashboard-workload-dispatched" v-if="$root.statsReady">
                    <span class="dashboard-workload-dispatched-label">
                        Jobs dispatched past {{ dispatchedJobsPeriod.toLowerCase() }}
                    </span>
                    <strong class="dashboard-workload-dispatched-value">
                        {{ statCount(stats.recentJobs) }}
                    </strong>
                </div>
            </div>
